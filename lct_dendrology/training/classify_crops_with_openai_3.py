...
def classify_crop_with_openai(image_bytes: bytes) -> str:
    ...
    classes = [
        "сильный наклон",
        "слабый наклон или отсутствует",
    ]
    prompt = (
        "Определи класс дерева на изображении. Сильный наклон ствола - неестственное 'наклонение' ствола на землю, которое может привести к его падению"
